...
public class AddNewPeopleFrame extends JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ProfileJFrame profileJFrame = new ProfileJFrame(this, this.nhanKhauBean);
        profileJFrame.setLocationRelativeTo(null);
        profileJFrame.setResizable(false);
        profileJFrame.setVisible(true);
