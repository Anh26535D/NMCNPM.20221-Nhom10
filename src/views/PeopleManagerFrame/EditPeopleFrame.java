...
import controllers.NhanKhauManagerController.EditController;
...
public class EditPeopleFrame extends JFrame {
    ...
    public EditPeopleFrame(JFrame parentJFrame) {
    	init();
	 ...
	 */
	public EditPeopleFrame(PeoplePanelController parentController, JFrame parentJFrame) {
        init();
	...
	private void init() {
		...
		EditBtn.setBounds(736, 415, 89, 30);
