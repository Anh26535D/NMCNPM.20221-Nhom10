	...
	private void initComponents() {
		...
		searchJtf.addFocusListener(new FocusListener() {
			...
			public void focusGained(FocusEvent e) {
				if (searchJtf.getText().equals(new String("Search"))) {
					searchJtf.setText("");
		...
		tableJpnLayout.setHorizontalGroup(tableJpnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGap(0, 0, Short.MAX_VALUE));
		tableJpnLayout.setVerticalGroup(tableJpnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		...
		layout.setHorizontalGroup(
				layout.createParallelGroup(Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap()
						.addComponent(jPanel1, GroupLayout.DEFAULT_SIZE, 724, Short.MAX_VALUE).addContainerGap()));
